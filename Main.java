...
public class Main {
    public static void main(String[] args) {
        BankAccount ba = new BankAccount("Raj", "1902");
        ba.checkId();
    }
...
class BankAccount {
    ...
    void checkId() {
        clrscr();
        System.out.println("Welcome to our Services Mr. " + customerName);
        System.out.println();
    ...
    private void showMenu() {
        ...
        do {
            ...
            switch (option) {
                ...
                case '5':
                    ...
                    BankAccount bb = new BankAccount("Saurabh", "6000");
        ...
        System.out.println("ThankYou Mr. "+customerName +" For Using Our Services");
